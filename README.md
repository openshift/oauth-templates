...
1. Copy the generated branding secret from `_site/_rho/branding-secret.yaml` to https://github.com/openshift/cluster-authentication-operator/blob/master/bindata/oauth-openshift/branding-secret.yaml.
